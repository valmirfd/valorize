...
class Customized
{
     ...
     * @param string $error
     */
    public function validate_cpf(string $cpf, string|null &$error = null): bool
    {
     ...
     * @param string $error
     */
    public function validate_phone(string $phone, string|null &$error = null): bool
    {
     ...
     * @return bool
     */
    public function validate_cnpj(string $cnpj, string|null &$error = null): bool
    {
