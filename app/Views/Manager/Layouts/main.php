...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?= route_to('manager.home') ?>"><?= APP_NAME ?></a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?= route_to('manager.home') ?>">Settings</a></li>
                    <li><a class="dropdown-item" href="<?= route_to('manager.home') ?>">Activity Log</a></li>
                    <li>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link <?php echo url_is("/manager") ? 'active' : ''; ?>" href="<?= route_to('manager.home'); ?>">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-house-lock"></i></div>
                            Home
                        </a>

                        <a class="nav-link <?php echo url_is("/manager/categorias") ? 'active' : ''; ?>" href="<?= route_to('categorias.list'); ?>">
