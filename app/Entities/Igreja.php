...
class Igreja extends Entity
{
    ...
    private function handleWithSingleImage(string $classImage, string $sizeImage): string
    {
        ...
        return img(
            [
                ...
                'src'       => route_to('image.igreja', $this->attributes['images'], $sizeImage),
    ...
    {
        //$url = ImageService::showImage(imagePath: 'igrejas', image: $image, sizeImage: $sizeImage);

        return site_url("assets/images/igrejas/small/$image");
    }
}
